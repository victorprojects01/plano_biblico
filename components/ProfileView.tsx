...
import { Award, Zap, Flame, LogOut } from 'lucide-react';
    ...
    <div className="flex flex-col gap-8 animate-in fade-in duration-700">
      ...
      <div className="bg-white rounded-[2.5rem] p-8 shadow-xl shadow-indigo-50/50 border border-slate-100">
        <div className="flex justify-between items-end mb-6">
          <div>
            <span className="text-[10px] font-black uppercase text-indigo-600 tracking-widest mb-1 block">Progresso do Plano</span>
          ...
          <div className="flex flex-col items-end">
            ...
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Dias ativos</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-50 p-6 rounded-[2rem] border-2 border-slate-100 flex flex-col items-center gap-1 group">
            ...
            <span className="text-[10px] font-bold uppercase text-slate-400 tracking-widest">Concluídos</span>
          </div>
          <div className="bg-slate-50 p-6 rounded-[2rem] border-2 border-slate-100 flex flex-col items-center gap-1 group">
            ...
            <span className="text-[10px] font-bold uppercase text-slate-400 tracking-widest">Pendentes</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 text-white p-8 rounded-[2.5rem] relative overflow-hidden group">
        ...
        <h4 className="text-xl font-extrabold mb-3 relative z-10 flex items-center gap-2">
          Continue firme! <Zap size={20} className="text-indigo-400" />
        </h4>
        <p className="text-slate-400 font-medium leading-relaxed relative z-10">
          Você já está à frente da maioria dos usuários que iniciaram o plano. A constância é o segredo para o crescimento espiritual.
        </p>
      </div>
    </div>
  );
